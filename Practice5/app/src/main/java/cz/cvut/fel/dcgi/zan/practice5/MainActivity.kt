...
import cz.cvut.fel.dcgi.zan.practice5.ui.CoroutinePlaygroundRoute
import cz.cvut.fel.dcgi.zan.practice5.ui.CoroutinePlaygroundScreen
...
fun PlaygroundApp() {
    ...
    val bottomNavItems = listOf(
        ...
        Triple(CoroutinePlaygroundRoute, "Test", Icons.Default.Settings),
    )
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable<CoroutinePlaygroundRoute> {
                CoroutinePlaygroundScreen()
            }
        }
    }
}
